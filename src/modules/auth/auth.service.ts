    ...
    async validateUserByPassword(loginAttempt: LoginUserDto) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if ( userToAttempt == null){
                resolve(new ServerMessages(true, "Usuario y/ó contraseña invalidos", {}));
            } else {
                ...
                if (checPass) {
                    ...
                    resolve(new ServerMessages(true, "Usuario y/ó contraseña invalidos", new UnauthorizedException()));
                }
            }
        });
